...
try:
    ...
    # ==============================================================
    # 6. Spalten-Mapping (CSV -> Excel)
    #    Werte anpassen! Nur Spalten mit zugewiesenem Buchstaben werden geschrieben.
    # ==============================================================

    # Hinweis:
    # - Key   = Spaltenname in der CSV
    # - Value = Spalte im Excel (Buchstabe, z.B. "A") oder Spaltenindex (1 = A, 2 = B, ...)
    # - Leerer String "" = wird übersprungen
    ...
    # ==============================================================
    # 7. Alte Daten ab start_row in den relevanten Spalten leeren
    # ==============================================================
    ...
    # ==============================================================
    # 8. Daten aus der CSV in das Excel-Sheet schreiben
    # ==============================================================
